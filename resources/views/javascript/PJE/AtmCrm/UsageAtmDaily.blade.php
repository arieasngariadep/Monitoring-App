...
<?php
    ...
    if(!empty($usageAtmDaily))
    {
        foreach($usageAtmDaily as $uAtm)
        {
            $date = $uAtm->tanggal;
            ...
            $jumlah_withd_usage[] = $uAtm->jumlah_withd_usage;
            $jumlah_transfer_usage[] = $uAtm->jumlah_transfer_usage;
            $jumlah_payment_usage[] = $uAtm->jumlah_payment_usage;
            $jumlah_inquiry_usage[] = $uAtm->jumlah_inquiry_usage;
        }
...
<script>
    Highcharts.chart('UsageAtmDaily', {
        chart: {
            type: 'spline'
        },
