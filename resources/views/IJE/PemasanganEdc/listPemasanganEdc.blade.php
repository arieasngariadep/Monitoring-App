...
@section('breadcrumbs')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">Pemasangan EDC</a></li>
        <li class="breadcrumb-item active">List Pemasangan EDC</li>
    </ol>
@endsection('breadcrumbs')

@section('title', 'List Pemasangan EDC')
@section('titleTab', 'List Pemasangan EDC')
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form action="<?= route('getListPemasanganEdc') ?>" method="GET">
                    <div class="row mt-3">
                        <div class="col-md-4">
                ...
                <div class="row mt-4">
                    <div class="col-md-5 text-right">
                        <form action="{{ route('exportReportPemasanganEdc') }}" method="POST">
                            {{ csrf_field() }}
                    ...
                    <div class="col-md-2 text-center">
                        <form action="<?= route('prosesDeletePemasanganEdcBulk') ?>" method="POST">
                            {{ csrf_field() }}
                            {{ method_field('DELETE') }}
                        ...
                        @if(count($listData) > 0)
                            @foreach($listData as $list)
                                ...
                                <tr>
                                    ...
                                    <td>{{ number_format($list->sesuai_sla, 0, '', '.') }}</td>
                                    <td>{{ round($list->persentase, 2) }} %</td>
                                    <td class='text-center'>
                                        <a href='<?= route('formUpdatePemasanganEdc', ['id' => $list->id]) ?>' class='btn btn-outline-success' data-toggle='tooltip' data-placement='top' title='' data-original-title='Form Update'>
                                            <i class='fa fa-edit'></i>
                                        </a> | 
                                        <a href='<?= route('prosesDeletePemasanganEdc', ['id' => $list->id]) ?>' class='btn btn-outline-danger' data-toggle='tooltip' data-placement='top' title='' data-original-title='Delete'>
