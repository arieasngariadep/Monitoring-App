...
@section('breadcrumbs')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Form Update Bulk Kas ATM/CRM</li>
    </ol>
@endsection('breadcrumbs')

@section('title', 'Form Update Bulk Kas ATM/CRM')
@section('titleTab', 'Form Update Bulk Kas ATM/CRM')
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="mt-0 header-title">Form Update Bulk Kas ATM/CRM</h4>
                <p class="text-muted mb-3"><span style="color: red;">Silahkan Download Report Terlebih Dahulu.</span></p>
                <form action="{{ route('prosesUpdateBulkKas') }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
