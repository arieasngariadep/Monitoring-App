...
@section('breadcrumbs')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Form Update Bulk Pagu Kas</li>
    </ol>
@endsection('breadcrumbs')

@section('title', 'Form Update Bulk Pagu Kas')
@section('titleTab', 'Form Update Bulk Pagu Kas')
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="mt-0 header-title">Form Update Bulk Pagu Kas</h4>
