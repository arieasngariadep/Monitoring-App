...
@section('breadcrumbs')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Form Update Bulk Availibility EDC</li>
    </ol>
@endsection('breadcrumbs')

@section('title', 'Form Update Bulk Availibility EDC')
@section('titleTab', 'Form Update Bulk Availibility EDC')
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="mt-0 header-title">Form Update Bulk Availibility EDC</h4>
                <p class="text-muted mb-3"><span style="color: red;">Silahkan Download Report Terlebih Dahulu.</span></p>
                <form action="{{ route('prosesUpdateBulkAvailibilityEdc') }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
