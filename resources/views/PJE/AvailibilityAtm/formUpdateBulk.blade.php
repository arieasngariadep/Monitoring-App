...
@section('breadcrumbs')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Form Update Bulk Availibility ATM</li>
    </ol>
@endsection('breadcrumbs')

@section('title', 'Form Update Bulk Availibility ATM')
@section('titleTab', 'Form Update Bulk Availibility ATM')
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="mt-0 header-title">Form Update Bulk Availibility ATM</h4>
