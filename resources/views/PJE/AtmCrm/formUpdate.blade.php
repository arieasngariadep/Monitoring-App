...
@section('breadcrumbs')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">List ATM CRM</a></li>
        <li class="breadcrumb-item active">Form Update ATM CRM</li>
    </ol>
@endsection('breadcrumbs')

@section('title', 'Form Update ATM CRM')
@section('titleTab', 'Form Update ATM CRM')
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="mt-0 header-title">Form Update ATM CRM</h4>
                <form class="form-horizontal auth-form my-4" action="<?= route('prosesUpdateAtmCrm') ?>" method="POST">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-lg-6">
